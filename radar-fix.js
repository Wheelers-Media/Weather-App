(() => {
  ...
  // Compatibility bridge: older cached app builds emitted the map-visible event on window,
  // while V10 listens on document. Forward it so either build can start the map.
  ...
  async function boot() {
    try {
      ...
      await Promise.all([
        addStyle('map-v6.css?v=20260813-1', 'shared-map-ui'),
        addStyle('map-core-v10.css?v=20260813-1', 'map-core-v10'),
        addStyle('map-polish-v10.css?v=20260813-1', 'map-polish-v10'),
        addStyle('https://cdn.maptiler.com/maptiler-sdk-js/v4.0.2/maptiler-sdk.css', 'maptiler-sdk')
      ]);
      await addScript('app-polish-v10.js?v=20260813-1', 'app-polish-v10');
      ...
      await addScript('map-core-v10.js?v=20260813-1', 'map-core-v10');
      await addScript('map-v10-bridge.js?v=20260813-1', 'map-v10-bridge');
      await addScript('location-accuracy-v10.js?v=20260813-1', 'location-accuracy-v10');
      await addScript('storm-composite-v10.js?v=20260813-1', 'storm-composite-v10');
